...
export const UPDATE_TESTIMOINAL_STATUS =
	'/testimonial/update-testimonial-status/';
...
export const UPDATE_PARTNER_GIVEN_AMOUNT_BY_ID =
	'/partner/update-partner-given-amount-by-id/';
/* PARTNER */
...
//first time recharge
export const CREATE_FIRST_TIME_RECHARGE =
	'/first-time-recharge/create-first-time-recharge-offer';
export const GET_ALL_FIRST_TIME_RECHARGE =
	'/first-time-recharge/get-all-first-time-offer';
export const EDIT_FIRST_TIME_RECHARGE =
	'/first-time-recharge/update-first-time-offer';
export const DELETE_FIRST_TIME_RECHARGE = '/first-time-recharge/delete-by-id';
export const CHANGE_STATUS_BY_ID =
	'/first-time-recharge/status-changestatusById-by-id';
