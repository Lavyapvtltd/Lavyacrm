				...
				if (inputLength > 0) {
					...
					Array.from(notifyItem).forEach(function (element: any) {
						...
						Array.from(
							...
							if (
								element.querySelectorAll('.notify-item.d-block').length == 0
							) {
	...
	return (
		<React.Fragment>
			<button
				...
				className='btn btn-sm px-3 fs-15 text-reset header-item d-none d-md-block'>
				<span className='bi bi-search me-2'></span> Search for velorm...
			</button>
