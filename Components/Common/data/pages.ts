...
const pricingPlans = [
	{
		...
		plan: 'Starter',
		price: '$19',
		planDesc: 'The perfect way to get started and get used to our tools.',
		projects: '3',
		customers: '299',
		ftpLogin: '5',
		currentplan: true,
	...
	},
	{
		...
		plan: 'Unlimited',
		price: '$49',
		planDesc: 'For most businesses that want to optimize web queries.',
		projects: 'Unlimited',
		customers: 'Unlimited',
		ftpLogin: 'Unlimited',
		support: true,
...
const searchResultsGalleryData = [
	{
		id: 1,
		img: smallImg1,
		caption: 'Glasses and laptop from above',
		captiondesc:
	...
	},
	{
		id: 2,
		img: smallImg2,
		caption: 'Pretty fun and relaxed day',
		captiondesc:
	...
	},
	{
		id: 3,
		img: smallImg3,
		caption: 'Photo was taken in Beach',
		captiondesc:
	...
	},
	{
		id: 8,
		img: smallImg8,
		caption: 'Team work, work colleagues, working together',
		captiondesc:
	...
	},
	{
		id: 10,
		img: smallImg10,
		caption: 'Solo trip to near by place mountain',
		captiondesc:
			'If several languages coalesce, the grammar of the resulting language is more simple and regular than that of the individual languages. The new common language will be more simple and regular.',
	},
	{
		id: 11,
		img: smallImg11,
		caption: 'Cycling in the countryside',
		captiondesc:
			'At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias.',
	},
	{
...
const searchResultsNewsData = [
	...
	},
	{
		...
		img: smallImg2,
		newsoutlet: 'News TV',
		newstitle: 'How to get creative in your work ?',
		name: 'Ruby Griffin',
		time: '1 days ago',
	},
	{
		...
		img: smallImg3,
		newsoutlet: 'News TV',
		newstitle: 'How to become a best sale marketer in a year!',
		name: 'Elwood Arter',
		time: '5 days ago',
	},
	{
		...
		img: smallImg4,
		newsoutlet: 'News TV',
		newstitle: 'Manage white space in responsive layouts ?',
		name: 'Elwood Arter',
		time: '1 month ago',
	},
	{
		...
		img: smallImg5,
		newsoutlet: 'News TV',
		newstitle: 'Stack designer Olivia Murphy offers freelancing advice',
		name: 'Elwood Arter',
		time: '24 Nov, 2022',
	},
	{
		...
		img: smallImg6,
		newsoutlet: 'News TV',
		newstitle: 'A day in the of a professional fashion designer',
		name: 'Elwood Arter',
		time: '19 Nov, 2022',
	},
	{
		...
		img: smallImg7,
		newsoutlet: 'News TV',
		newstitle: 'Design your apps in your own way',
		name: 'Elwood Arter',
		time: '19 Nov, 2022',
	},
	{
		...
		img: smallImg8,
		newsoutlet: 'News TV',
		newstitle: 'How apps is changing the IT world',
		name: 'Elwood Arter',
		time: '19 Nov, 2022',
	},
];
...
const basicTeamExampleData = [
	{
		...
		img: avatar9,
		name: 'Jordan Martino',
		email: 'jordan.martino@velorm.com',
	},
	{
		id: 2,
		img: avatar10,
		name: 'Nancy Martino',
		email: 'nancy.martino@velorm.com',
	},
	{
		id: 3,
		img: avatar1,
		name: 'Pieter Novitsky',
		email: 'pieter.novitsky@velorm.com',
	},
	{
		id: 4,
		img: avatar9,
		name: 'Allyson Booker',
		email: 'allyson.booker@velorm.com',
	},
	{
		id: 5,
		img: avatar3,
		name: 'Cristofer Leblanc',
		email: 'cristofer.leblanc@velorm.com',
	},
];

export {
	simplePageProjectData,
	pricingPriceList,
	pricingPlans,
	pricingPackageplan,
	pricingPriceplan,
	searchResultsSwiperData,
	searchResultsGalleryData,
	searchResultsNewsData,
	searchResultsImagesData,
	teamMemberList,
	basicTeamExampleData,
};
