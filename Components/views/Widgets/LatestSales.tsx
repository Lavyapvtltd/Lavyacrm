							...
							<table className='table table-borderless align-middle mb-0'>
								<thead className='table-active'>
									<tr>
										<th scope='col'>
											Email
											<i className='ri-arrow-up-down-line align-middle ms-2'></i>
										</th>
										<th scope='col'>
											Price
											<i className='ri-arrow-up-down-line align-middle ms-2'></i>
								...
								<tbody>
									<tr>
										<td>jordan.martino@velorm.com</td>
										<td>$1.95</td>
										<td>
											<Link
												href='#'
									...
									<tr>
										<td>nancy.martino@velorm.com</td>
										<td>$5.00</td>
										<td>
											<Link
												href='#'
									...
									<tr>
										<td>pieter.novitsky@velorm.com</td>
										<td>$2.05</td>
										<td>
											<Link
												href='#'
