...
const SigninCover = () => {
	...
	return (
		<React.Fragment>
			<Head>
				<title>Sign In | velorm -Admin </title>
			</Head>
						...
						<Col
							...
							<div className='h-100 mb-0 p-4 d-flex flex-column justify-content-between'>
								...
								<div className='text-white mt-4'>
									<p className='mb-0'>
										&copy; {new Date().getFullYear()} velorm. Crafted with{' '}
							...
							<Card className='mb-0 py-5'>
								<Card.Body className='p-4 p-sm-5 m-lg-2'>
									<div className='text-center mt-2'>
										...
										<p className='text-muted'>Sign in to continue to velorm.</p>
									</div>
									<div className='p-2 mt-5'>
										<form action='#'>
											...
											<div className='mb-3'>
												<div className='float-end'>
													<Link
														href='/auth-pages/passwordreset/pass-reset-basic'
										...
										<div className='text-center mt-5'>
											<p className='mb-0'>
												...
												<Link
													href='/auth-pages/singup/signup-cover'
