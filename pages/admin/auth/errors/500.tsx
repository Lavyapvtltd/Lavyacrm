...
const Error500 = () => {
	return (
		<React.Fragment>
			<Head>
				<title>500 Error | velorm -Admin </title>
			</Head>
						...
						<Col lg={12}>
							<Card>
								<Card.Body>
									<Row className='g-0'>
										<Col lg={5}>
											<Card className='auth-card bg-primary h-100 border-0 shadow-none p-3 overflow-hidden mb-0'>
												<Card.Body className='p-4 d-flex justify-content-between flex-column'>
													...
													<div className='text-center text-white-75'>
														<p className='mb-0'>
															&copy;
															{new Date().getFullYear()} velorm. Crafted with{' '}
...
Error500.getLayout = function getLayout(page: any) {
